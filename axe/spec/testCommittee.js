...
describe('ezamendment demo', function() {
    ...
    beforeEach(function(done) {
        ...
        driver.get('http://stage-fecportal-fec-ef-app.b9ad.pro-us-east-1.openshiftapps.com/committee/C00577759')
            .then(function () {
                done();
            });
    });
    ...
    it('should analyze the Committee Page', function (done) {
        ...
        AxeBuilder(driver)
            .analyze(function(results) {
                ...
                if (results.violations.length > 0) {
                    ...
                    var stream = fs.createWriteStream("reports/testCommittee.html");
